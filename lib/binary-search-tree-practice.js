...
class BSTree {
  ...
  insert (key) {
    ...
    const leftHeight = leftChildren.height
    const rightHeight = rightChildren.height
  ...
  rotateLeft (node) {
    ...
    const nodeRightLeftChild = nodeRight.left
  ...
  rotateRight (node) {
    ...
    const nodeLeftRightChild = nodeLeft.right
